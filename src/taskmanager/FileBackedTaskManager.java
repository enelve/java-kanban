...
public class FileBackedTaskManager extends InMemoryTaskManager {
    ...
    public static void main(String[] args) {
        ...
        Assert.assertEquals(manager1.getHistory(), manager2.getHistory());
        Assert.assertEquals(manager1.getTasks(), manager2.getTasks());
        Assert.assertEquals(manager1.getSubTasks(), manager2.getSubTasks());
        Assert.assertEquals(manager1.getEpics(), manager2.getEpics());
    }
